...
parser.add_argument("data", type=str,  help="A directory with data. The directory must contain two folders train and test. Both these folders must contain two subfolders input and target.")
...
def main(model_path, data_path):
    ...
    if os.path.isdir(X_trn_path) is False or os.path.isdir(y_trn_path) is False or os.path.isdir(X_val_path) is False or os.path.isdir(y_val_path) is False:
